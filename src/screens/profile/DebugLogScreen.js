...
const DebugLogScreen = () => {
  ...
  const fetchLogs = async () => {
    try {
      ...
      // Get the current in-memory breadcrumbs
          ...
          {breadcrumbs.length === 0 ? (
            ...
            breadcrumbs.map((crumb, index) => (
              <TouchableOpacity
                ...
                onLongPress={() => copyToClipboard(JSON.stringify(crumb, null, 2))}
              >
          ...
          {errorLogs.length === 0 ? (
            ...
            errorLogs.map((log, index) => (
              <TouchableOpacity
                key={index}
                style={styles.logItem}
                onLongPress={() => copyToClipboard(JSON.stringify(log, null, 2))}
              >
                ...
                {log.stack && (
                  <TouchableOpacity 
                    ...
                    onPress={() => copyToClipboard(log.stack)}
                  >
