 ...
 * and provides the appropriate navigator based on auth status
 */
      ...
      >
        <Stack.Navigator
          screenOptions={{
            ...
            // Only detach previous screen on non-tablet devices
            detachPreviousScreen: Platform.OS === 'ios' ? !(Platform as any).isPad : false,
          }}
        >
          {isAuthenticated ? (
            // User is signed in
