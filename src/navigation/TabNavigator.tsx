...
export type HomeStackParamList = {
  ...
  PublicationSuccess: { animalId: string };
  AdoptionApplication: { animalId: string };
  AdoptionSuccess: { applicationId: string };
};

export type AddStackParamList = {
  AddMain: { editMode?: boolean };
  PublicationSuccess: { animalId: string };
};
...
export type ProfileStackParamList = {
  ...
  DebugLogs: undefined;
  AdoptionProgress: { applicationId: string };
...
const AddStackScreen: React.FC<StackScreenProps> = ({ navigation }) => {
...
const ProfileStackScreen: React.FC<StackScreenProps> = ({ navigation }) => {
  // Handle back button press/gesture
  React.useEffect(() => {
    const onBackPress = () => {
